...
namespace RPMS.WinForms.Forms.Landlord
{
    public class LandlordPostForm : Form
    {
        ...
        private void BtnAddImages_Click(object? sender, EventArgs e)
        {
            ...
            {
                Multiselect = true,
                Filter = "Ảnh & Video|*.jpg;*.jpeg;*.png;*.bmp;*.webp;*.mp4;*.webm;*.avi;*.mov|Ảnh|*.jpg;*.jpeg;*.png;*.bmp;*.webp|Video|*.mp4;*.webm;*.avi;*.mov",
                Title = "Chọn ảnh / video cho tin đăng"
            };
