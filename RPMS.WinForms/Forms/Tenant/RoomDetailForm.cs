...
namespace RPMS.WinForms.Forms.Tenant
{
    public class RoomDetailForm : Form
    {
        ...
        private void InitializeUI()
        {
            ...
            picMain.Click += (s, e) => ShowFullscreen();
        ...
        private void BuildThumbs()
        {
            ...
            for (int i = 0; i < _images.Count; i++)
            {
                ...
                ImagePathHelper.ApplyToPictureBox(thumb, _images[i], "");
        ...
        private void ShowImage(int index)
        {
            ...
            _index = index;
            ImagePathHelper.ApplyToPictureBox(picMain, _images[_index], "Không tải được ảnh");
        }
