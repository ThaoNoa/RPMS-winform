...
namespace RPMS.WinForms.Forms.Tenant
{
    public class InvoiceDetailForm : Form
    {
        ...
        private void BuildUi()
        {
            ...
            var btnPrint = new ModernButton { Text = "In / Preview", Size = new Size(120, 40), BackColor = AppColors.Primary, Margin = new Padding(0, 0, 8, 0) };
            ...
            var btnExcel = new ModernButton { Text = "Excel", Size = new Size(90, 40), BackColor = AppColors.Success, Margin = new Padding(0, 0, 8, 0) };
            btnExcel.Click += (s, e) => ExportExcelOne();
            ...
            flpButtons.Controls.AddRange(new Control[] { btnPay, btnPrint, btnPdf, btnExcel, btnClose });
        ...
        private void ExportExcelOne()
        {
            ExportHelper.ExportExcelCsv(
                $"{_invoice.InvoiceCode}.csv",
                new[] { "Mã HĐ", "Phòng", "Tiền phòng", "Điện", "Nước", "Phí khác", "Tổng", "Trạng thái", "Hạn TT" },
                new[]
                {
                    new[]
                    {
                        ...
                        _invoice.RoomNumber ?? "",
                        _invoice.Rent.ToString("0"),
                        _invoice.ElectricCost.ToString("0"),
                        _invoice.WaterCost.ToString("0"),
                        _invoice.OtherFee.ToString("0"),
                        _invoice.Total.ToString("0"),
                        _invoice.Status ?? "",
