...
namespace RPMS.WinForms.Forms.Shared
{
    public class ReportForm : Form
    {
        ...
        private void InitializeUI()
        {
            ...
            var btnCsv = new ModernButton { Text = "Xuất Excel (CSV)", Location = new Point(700, 16), Size = new Size(160, 36) };
            btnCsv.Click += async (s, e) => await ExportCsvAsync();
            var btnHtml = new ModernButton { Text = "Xuất PDF/HTML", Location = new Point(880, 16), Size = new Size(150, 36), BackColor = AppColors.Success };
            ...
            pnlBody = new Panel { Dock = DockStyle.Fill, AutoScroll = true, Padding = new Padding(16) };
